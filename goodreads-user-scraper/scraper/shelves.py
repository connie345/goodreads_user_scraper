...
def get_shelf(args: Namespace, shelf: str, username):
    ...
    while True:
        ...
        for book_row in book_rows:
            ...
            # If not already scraped, scrape the book and add the shelf
                ...
                book = books.scrape_book(book_id, args,username)
                book["user_rating"] = get_rating(book_row)
...
def get_all_shelves(args: Namespace):
    ...
    username = soup.find(id="profileNameTopHeading").text.strip()
